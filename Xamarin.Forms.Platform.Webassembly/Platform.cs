	...
	public class Platform : BindableObject, INavigation
	{
		...
		public IReadOnlyList<Page> NavigationStack
		{
			get { throw new InvalidOperationException(
				"NavigationStack is not supported globally on Webassembly, please use a NavigationPage."); }
		}
		...
		{
			throw new InvalidOperationException("PushAsync is not supported globally on Webassembly, please use a NavigationPage.");
		}

		Task<Page> INavigation.PopAsync(bool animated)
		{
			throw new InvalidOperationException("PopAsync is not supported globally on Webassembly, please use a NavigationPage.");
		}

		Task INavigation.PopToRootAsync(bool animated)
		{
			throw new InvalidOperationException("PopToRootAsync is not supported globally on Webassembly, please use a NavigationPage.");
		}

		void INavigation.RemovePage(Page page)
		{
			throw new InvalidOperationException("RemovePage is not supported globally on Webassembly, please use a NavigationPage.");
		}
